...
public class CRUDTester extends DB {
...
//        Customer c = new Customer("Homer@quote-decor.com");
...
//        Customer c = new Customer("Homer@quote-decor.com");
        ...
        // Customer +> all associated projects, rooms, reviews, quotes.
        // Company  +> all above +> labour_costs .
//        db.insertUpdateDelete("DELETE FROM customer WHERE email = 'Dane@quote-decor.com';");
//        db.printTableCompany();

        // TODO -> in-progress -> testing and refining company DB operations

//        Company company = new Company("1@quote-decor.com");
//        company.labour.setPapering(1.50);
//        company.labour.update();
